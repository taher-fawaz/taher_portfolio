...
class MultiTrackTween extends Animatable<Map<String, dynamic>> {
  final Map<String, _TweenData> _tracksToTween = <String, _TweenData>{};
  var _maxDuration = 0;
...
class ControlledAnimation<T> extends StatefulWidget {
  ...
  final Widget Function(BuildContext buildContext, dynamic animatedValue)?
      builder;
  final Widget Function(BuildContext, Widget child, dynamic animatedValue)?
      builderWithChild;
  final Widget? child;
